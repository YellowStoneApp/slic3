...
const DarkModeToggler = ({ themeMode = 'light', onClick, className, ...rest }: DarkModeTogglerProps): JSX.Element => {
    ...
    return (
        <span className={clsx(classes.root, className)} {...rest} onClick={onClick}>
            ...
            <div className={clsx(classes.modeToggler, themeMode === 'dark' ? classes.modeTogglerDark : '')}>
                <svg className={classes.modeTogglerIcon} aria-hidden="true" width="14" height="13" viewBox="0 0 14 13" xmlns="http://www.w3.org/2000/svg">
                    <path
                        fillRule="evenodd"
                        clipRule="evenodd"
