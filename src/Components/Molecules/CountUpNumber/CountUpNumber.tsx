...
const CountUpNumber = ({
    ...
    return (
        <div className={clsx('countup-number', className)} {...rest}>
            <VisibilitySensor onChange={(isVisible) => setViewPortVisibility(isVisible)} delayedCall {...visibilitySensorProps}>
                <div className="countup-number__wrapper" {...wrapperProps}>
                    ...
                    <Typography variant="subtitle1" color={labelColor || 'textSecondary'} align="center" className="countup-number__label" {...labelProps}>
                        {label}
                    </Typography>
                </div>
            </VisibilitySensor>
