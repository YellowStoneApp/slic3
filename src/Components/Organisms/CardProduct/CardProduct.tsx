...
const CardProduct = ({
    ...
    return (
        <Card
            ...
            {...rest}
        >
            <CardMedia className={clsx('card-product__media', classes.media, mediaClassName)}>{mediaContent}</CardMedia>
            <CardContent className={clsx('card-product__content', classes.content, classes[align])}>{cardContent}</CardContent>
        </Card>
    );
};
